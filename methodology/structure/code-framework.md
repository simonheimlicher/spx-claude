...
BSP (Build Sequence Position) determines dependency order. Items with lower BSP must be built before items with higher BSP. Items with the same BSP can be built in parallel.
