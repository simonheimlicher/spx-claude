...
The target structure co-locates specs, tests, and outcomes.yaml:
...
5. **For each container** (capability, feature, story):
   ...
   - Do NOT move `testing/fixtures/` or `testing/harnesses/` (shared infrastructure)
     e. **Do NOT create outcomes.yaml** - that's machine-generated by `spx spx commit`
