...
- **Baseline**: Plugins reference `specs/work/` paths, use test graduation, lack `outcomes.yaml` awareness
...
| Status         | `DONE.md` marker files            | `outcomes.yaml` with pass/fail lists |
...
- [ ] `outcomes.yaml` documented as status mechanism
