...
3. **Verification ledger**: `outcomes.yaml` tracks test verification with blob SHAs. Generated by `spx spx commit`.
...
| State                | Condition                         |
| -------------------- | --------------------------------- |
| **Spec only**        | No `outcomes.yaml`                |
| **In progress**      | `outcomes.yaml` has failing tests |
| **Outcome achieved** | All tests pass in `outcomes.yaml` |

```yaml
# Example outcomes.yaml (machine-generated by spx spx commit)
spec_blob: a3f2b7c...
committed_at: 2025-01-27T10:30:00Z
tests:
  - file: parsing.unit.test.ts
    blob: a3f2b7c
    passed_at: 2025-01-27T10:30:00Z
