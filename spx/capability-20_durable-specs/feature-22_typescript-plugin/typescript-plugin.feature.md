...
TypeScript plugin skills work with CODE structure: reference `spx/` paths, use co-located tests with suffix naming, understand `status.yaml`.
...
| orchestrating-typescript | Update workflow to use `spx/` paths, `status.yaml` for progress        |
